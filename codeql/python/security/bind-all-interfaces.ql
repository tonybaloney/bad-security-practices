 ...
 * @description Binding a socket to all interfaces opens it up to traffic from any IPv4 & IPv6 address
...
string allInterfaces() { result = "0.0.0.0" or result = "" or result = "::" or result = "0:0:0:0:0:0:0:0" }
